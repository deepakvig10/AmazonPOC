...
public class StepImplementation {
    ...
    public void takeScreenshot() throws IOException {
        try {
            ...
            ImageIO.write(image, "PNG", new File("reports/html-report/" + fileName));
    ...
    public void implementation3() {
        driver.findElement(By.id("toCity")).sendKeys(Keys.TAB);
    }

    @Step("Press Enter key on <element>")
    public void implementation4(String element) {
        driver.findElement(By.id("twotabsearchtextbox")).sendKeys(Keys.ENTER);
    }

    @Step("Switch to another window Tab")
